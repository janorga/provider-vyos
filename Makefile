# ====================================================================================
# Setup Project
PROJECT_NAME := provider-vyos
PROJECT_REPO := github.com/janorga/$(PROJECT_NAME)
...
xpkg.build.provider-vyos: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider VyOS CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider VyOS controllers
...
# This target prepares repo for your provider by replacing all "vyos"
