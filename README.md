...
Testing a Custom Crossplane Provider for VyOS. Based on VyOS API Client in Go from https://github.com/Foltik/vyos-client-go.
...
1. Use this repository as a vyos to create a new one.
